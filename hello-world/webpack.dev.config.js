...
// const TerserPlugin = require('terser-webpack-plugin');  // npm install terser-webpack-plugin --save-dev (if use webpack version >= 5, do not need to install), do not need to optimize code in dev mode
// const MiniCssExtractPlugin = require('mini-css-extract-plugin');  // npm install mini-css-extract-plugin --save-dev, do not need to extract css in dev mode
...
module.exports = {
	...
	output: {
		filename: '[name].bundle.js',  // take the name of entry
	...
	module: {
		rules: [
			...
			// 	test: /\.(css)$/,
			// 	use: [
			// 		// MiniCssExtractPlugin.loader, 'css-loader'  // npm install css-loader style-loader --save-dev, do not need to extract css in dev mode
			...
			// },
			{
				test: /\.(scss)$/,
				use: [
					// MiniCssExtractPlugin.loader, 'css-loader', 'sass-loader'  // npm install sass-loader sass --save-dev, webpack use loaders from right to left, do not need to extract css in dev mode
	...
	plugins: [
		// new TerserPlugin(),  // minimize the size of js bundle, do not need to optimize code in dev mode
		// new MiniCssExtractPlugin({
		// 	filename: 'style.[contenthash].css'  // extract css into a seperate bundle file, do not need to extract css in dev mode
		// }),
